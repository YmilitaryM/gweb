<template>
  <section class="relative h-[980px] flex flex-col justify-center bg-white">
    <div class="absolute top-0 left-0 right-0 h-20 pointer-events-none" style="background: linear-gradient(to top, transparent, rgba(248,250,252,0.9));"></div>
    <div class="absolute bottom-0 left-0 right-0 h-20 pointer-events-none" style="background: linear-gradient(to bottom, transparent, rgba(15,23,42,0.35));"></div>
