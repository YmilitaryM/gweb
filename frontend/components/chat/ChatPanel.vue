  ...
  <Teleport to="body">
    ...
    <div
      ...
      :style="{
        ...
        borderLeft: '1px solid rgba(5,150,105,0.05)',
        boxShadow: '-8px 0 40px rgba(0,0,0,0.06)',
      }"
    >
      <!-- Header -->
      <div class="flex items-center justify-between px-5 py-4" style="border-bottom: 1px solid rgba(5,150,105,0.06);">
        <div class="flex items-center gap-2.5">
          <div class="w-7 h-7 rounded-lg flex items-center justify-center"
            style="background: linear-gradient(135deg, rgba(5,150,105,0.1), rgba(2,132,199,0.1));">
            <svg class="w-3.5 h-3.5" style="color: #059669;" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      ...
      <div ref="msgContainer" class="flex-1 overflow-y-auto px-4 py-4 space-y-3">
        ...
        <div v-for="(msg, i) in messages" :key="i" :class="msg.role === 'user' ? 'text-right' : 'text-left'">
          <div
            :style="msg.role === 'user'
              ...
              : 'background: rgba(5,150,105,0.04); border: 1px solid rgba(5,150,105,0.06);'"
        ...
        <div v-if="streaming" class="text-left">
          <div class="inline-block max-w-[85%] rounded-xl px-3.5 py-2 text-[13px] leading-relaxed text-slate-700"
            style="background: rgba(5,150,105,0.04); border: 1px solid rgba(5,150,105,0.06);">
      ...
      <!-- Input -->
      <div class="px-4 py-3" style="border-top: 1px solid rgba(5,150,105,0.06);">
        <form @submit.prevent="sendMessage" class="flex gap-2">
          <input
            ...
            style="border-color: rgba(5,150,105,0.12); background: rgba(5,150,105,0.02); color: #334155;"
          />
          <button
            type="submit"
            ...
            style="background: linear-gradient(135deg, #059669, #10b981); box-shadow: 0 2px 8px rgba(5,150,105,0.2);"
          >
